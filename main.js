...
(function () {
  ...
  var EN = {
    ...
    faq_p_a1: "Most of the honing work is done with advanced water-based machines (wet honing) on a three-phase power connection, which prevents dust almost entirely. That said, at certain stages — such as grooving the grout lines (the gaps between tiles) or honing panels and the corners the large machine can't reach — a little dust may form. To keep the space clean, we move out portable furniture and hermetically wrap any furniture that can't be moved in protective nylon.",
