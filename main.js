...
(function () {
  ...
  var EN = {
    ...
    testi1_quote: "\"Uri is simply a pro! My floor was scratched and worn out and he turned it into a shining mirror. Highly recommended!\"",
    testi1_author: "- The Levi family, Ra'anana",
    testi2_quote: "\"Service beyond expectations. They arrived on time, kept the house clean, and the crystal-polish result is just incredible.\"",
    testi2_author: "- Aviv Cohen, Herzliya",
    testi3_quote: "\"He renewed our old 30-year-old marble floor — I couldn't believe it could look like that again. Worth every shekel.\"",
    testi3_author: "- Ronit Dan, Netanya",
    testi4_quote: "\"We hired Uri to polish old stone stairs in a shared building. Amazing, thorough and professional work — all the residents are thrilled!\"",
    testi4_author: "- Yuval Gal, Kfar Saba",
    testi5_quote: "\"A true professional in every sense. He gave a fair quote and did an incredible polish on our new apartment before we moved in.\"",
    testi5_author: "- Shani &amp; Maor, Tel Aviv",
    testi6_quote: "\"We had tough stains on the concrete and living-room surfaces that wouldn't come off for years. Uri came with his machines and everything looks brand new.\"",
    testi6_author: "- Tomer Azoulay, Ra'anana",
    ...
    faq_p_a1: "Not at all. We use advanced water-based (wet) honing machines connected to powerful vacuum extractors. The process keeps your home completely clean, with not a single speck of dust in the air.",
    faq_p_q2: "What's the difference between crystal polish and wax polish?",
    faq_p_a2: "Wax polish is a temporary protective layer applied on top of the floor that tends to wear off quickly. Crystal polish, by contrast, is a magnetic process that draws the shine out of the stone itself. It lasts significantly longer, leaves no footprints, and isn't slippery.",
    faq_p_q3: "Do I need to clear all the furniture out before you arrive?",
    faq_p_a3: "Please clear light furniture and decorative items from the area to be treated. For heavy, complex furniture (such as large cabinets or massive sofas), we prepare in advance and maneuver around them safely and professionally to ensure complete coverage.",
    ...
    faq_pr_a2: "In standard residential apartments, a quality crystal polish stays in excellent condition for 3 to 5 years, depending on the level of wear and the cleaning method (we recommend washing with dedicated products to preserve the shine).",
